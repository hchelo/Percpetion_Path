...
# Crear una imagen en color azul
imagen_azul = np.zeros_like(imagen)
imagen_azul[:, :] = [255, 0, 0]  # Azul en formato BGR

# Crear máscara binaria a partir de la imagen final
mask = imagen_final > 0

# Aplicar la máscara a la imagen original, pintando las áreas detectadas de azul
imagen_resultado = imagen.copy()
imagen_resultado[mask] = imagen_azul[mask]
...
cv2.imshow('Imagen con Tomates en Azul', imagen_resultado)
